...
function LoginContent() {
    ...
    async function handleEmailLogin(e: React.FormEvent<HTMLFormElement>) {
        ...
        try {
            ...
            // Require email verification for university portal
            if (loginType === "university" && !result.user.emailVerified) {
                await auth.signOut();
                        ...
                        >
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input
                                            ...
                                            placeholder={loginType === "university" ? "admin@mitadt.edu.in" : "example@student.edu"}
                                        />
                                    </div>
                                </div>
                            ...
                            <div className="text-center pt-1 pb-2 space-y-2">
                                {loginType === "university" && (
                                    <Link href="/forgot-password" title="Reset Password" className="block text-slate-400 hover:text-green-600 font-bold text-[11px] sm:text-xs transition-colors">
                                        Forgot Password?
                                    </Link>
                                )}
